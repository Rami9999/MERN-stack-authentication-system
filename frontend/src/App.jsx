...
const ProtectedRoute = ({children})=>{
  ...
  if(!isAuthenticated)
  {
    return <Navigate to="/login" force/>
  }

  if(!user.isVerified)
    {
      return <Navigate to="/verify-email" force/>
    }

  return children;
}

//redirect if authnitaced
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br
     ...
     relative overflow-hidden">
      ...
      <FloatingShape color="bg-emerlad-500 " size="w-48 h-48" top="70%" left="80%" delay={0}/>
